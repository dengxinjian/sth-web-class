          ...
          <div class="body-title">
            ...
            <el-popover popper-class="athletic-btn-popover"
              ...
              <img src="@/assets/addClass/Component 117.png" alt=""
                @click.stop
                slot="reference" style="width: 16px; height: 16px" />
            </el-popover>
          </div>
...
export default {
  ...
  computed: {
    ...
    canEdit() {
      return this.isEliteAthlete || !this.isFutureDate(this.date)
    },
    cardStyle() {
      // 过期且有时长的课程显示为红色
      if (
