<template>
    ...
    >
      <span slot="title">力量</span>

      <div class="form-section">
        <el-form :model="form" label-width="60px">
          <el-form-item label="标题：">
            <el-input v-model="form.title" placeholder="标题" disabled class="pill-input" />
          </el-form-item>
          ...
          <div class="row">
            ...
            <div class="row-item">
              ...
              <el-input-number :step="1" :min="0" :step-strictly="true" :controls="false" v-model="form.sth" placeholder="" class="pill-input short" disabled />
            </div>
          </div>
