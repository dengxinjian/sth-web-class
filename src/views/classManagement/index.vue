          ...
          <div class="schedule-class-container">
            <el-collapse accordion @change="classSlideChange">
              ...
              >
                ...
                <div
                  class="class-drag-container"
                  :key="item.timespan"
                  style="min-height: 20px"
                >
                  <div
                    v-for="part in item.classesList"
                    :key="item.groupId + '-' + part.id"
        ...
        <div class="schedule-table">
          ...
          <div class="schedule-table-body">
            ...
            >
              ...
              <div
                class="schedule-table-cell-item schedule-drag-container"
              ...
              >
                ...
                <div
                  ...
                  :class="
                    activityItem.classesJson
                      ...
                      : 'sport-container-noDrag sport-container-put'
                  "
                ...
                <div
                  ...
                  "
                >
                  <div class="class-block-title-delete">
                    <i
                  ...
                  >
                    ...
                    >
                      <div
                        :style="{ display: 'flex', gap: '2px', height: '16px' }"
                      >
...
export default {
  ...
  methods: {
      ...
      getData({
        ...
        .then((res) => {
          if (res.success && res.result) {
            ...
            this.$nextTick(() => {
              document
                .querySelectorAll(".schedule-drag-container")
                .forEach((el) => {
                  new Sortable(el, {
              ...
              const _this = this;
              document
                .querySelectorAll(".sport-container-put")
                .forEach((el) => {
                  new Sortable(el, {
                    sort: false,
    ...
    async AddScheduleClass(data) {
      ...
      // 只用快照，不用外部 data.classesJson
      const newClassesJson = {
        ...originalClassesJson,
      ...
      submitData({
        ...
        requestData: {
          ...data,
          classesJson: JSON.stringify(newClassesJson),
          triUserId: this.selectedAthletic,
        },
      }).then((res) => {
        if (res.success) {
