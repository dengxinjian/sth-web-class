          ...
          <div class="content-overlay">
            ...
            <div class="wx-login-block">
               ...
               <div id="wx-login-container" class="wx-login-container">
                 ...
                 <!-- 小程序码状态 -->
                 <div v-else-if="wxLoginStatus === 'miniprogram'" class="miniprogram-code">
                   <div class="miniprogram-title">请使用微信扫码</div>
                   <img src="./imgs/miniprogram.png" alt="小程序码" class="miniprogram-img">
    ...
    createWxLogin() {
      try {
        ...
        const redirectUri = encodeURIComponent(
          'https://webtest.strongtri.com/strong-heart-training/api/wechat/callback'
        );
